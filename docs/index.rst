...
2. If the function is called only positional arguments, then the unicode value
   of each argument is joined with ``', '`` and surrounded by parentheses. For
   example::
...
For a complete list of these helper functions see 
